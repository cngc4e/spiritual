    ...
    local MD_SCHEMA = {
        [1] = {
            ...
            db2.VarDataList{ key="maps", size=10000, datatype=db2.Object{schema={
                ...
                db2.UnsignedInt{ key="completed_hard", size=3 },
                db2.UnsignedInt{ key="completed_divine", size=3 },
                db2.UnsignedInt{ key="rounds_hard", size=3 },
                db2.UnsignedInt{ key="rounds_divine", size=3 },
            }}},
    ...
    local operations = {
        ...
        [TsmModuleData.OP_ADD_MAP_COMPLETION_HARD] = {
            ...
            merge = function(self, db)
                ...
                if self.completed then
                    found.completed_hard = db2.minuint(found.completed_hard + 1, 3)
                end
                found.rounds_hard = db2.minuint(found.rounds_hard + 1, 3)
        ...
        [TsmModuleData.OP_ADD_MAP_COMPLETION_DIVINE] = {
            ...
            merge = function(self, db)
                ...
                if self.completed then
                    found.completed_divine = db2.minuint(found.completed_divine + 1, 3)
                end
                found.rounds_divine = db2.minuint(found.rounds_divine + 1, 3)
                return MDHelper.MERGE_OK
            end,
            logobject = function(self)
                return nil
